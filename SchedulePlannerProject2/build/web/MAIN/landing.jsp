...
<html>
    <head>
        ...
        <title>Schedule Planner Project 2</title>
    </head>
    <body>
        <h1>Schedule Planner: Project 2</h1>
        <a href="<%= request.getContextPath() %>/main/search.jsp"
            >Search for Classes</a
        >
        <br />
        <a href="<%= request.getContextPath() %>/main/registration.jsp"
            >Register for Classes</a
        >
        <br />
        <a href="<%= request.getContextPath() %>/main/schedule.jsp"
            >Look at Current Schedule</a
        >
        <br />
        <a href="<%= request.getContextPath() %>/main/drop.jsp"
            >Drop a Course</a
        >
        <br />
        <a href="<%= request.getContextPath() %>/main/report.jsp"
            >Generate Schedule as PDF</a
        >
        <p>
            <input
                type="button"
